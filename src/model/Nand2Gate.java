...
import gui.Nand2Image;
import java.awt.Point;

/**
 * <code>Nand2Gate</code> extends the abstract class
 ...
 * @see Nand4Gate
 */
public class Nand2Gate extends LogicComponent {
    
    /**
     * Constructs a solitary new <code>Nand2Gate</code> object.
     *
     * @param model the model
     */
    public Nand2Gate(Model model) {
        super(model, 2, 1);
    }
     ...
     * <code>LogicComponent</code> object. All <code>Nand2Gate</code> objects 
     * return <code>Nand2Gate.TYPE_STRING</code>.
     *
    ...
    static final public String TYPE_STRING = "nand2";
