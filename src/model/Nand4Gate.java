 ...
 * @see Nand3Gate
 */
public class Nand4Gate extends LogicComponent {
    
    /**
     * Constructs a solitary new <code>Nand4Gate</code> object.
     *
     * @param model the model
     */
    public Nand4Gate(Model model) {
        super(model, 4, 1);
    }
     ...
     * <code>LogicComponent</code> object. All <code>Nand4Gate</code> objects 
     * return <code>Nand4Gate.TYPE_STRING</code>.
     *
    ...
    static final public String TYPE_STRING = "nand4";
