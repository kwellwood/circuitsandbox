...
/**
 * <code>Or2Gate</code> extends the abstract class <code>LogicComponent</code>,
 * implementing the logic required to simulate a two-input OR gate.
 *
 * @author Daniel Stahl
 ...
 * @see Or4Gate
 */
public class Or2Gate extends LogicComponent {
    
    /**
     * Constructs a solitary new <code>Or2Gate</code> object.
     *
     * @param model the model
     */
    public Or2Gate(Model model) {
        super(model, 2, 1);
    }
     ...
     * <code>LogicComponent</code> object. All <code>Or2Gate</code> objects 
     * return <code>Or2Gate.TYPE_STRING</code>.
     *
    ...
    /** used to identify <code>Or2Gate</code> objects */
    static final public String TYPE_STRING = "or2";
