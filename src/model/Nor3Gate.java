...
/**
 * <code>Nor3Gate</code> extends the abstract class
 ...
 * @see Nand4Gate
 */
public class Nor3Gate extends LogicComponent {
    
    /**
     * Constructs a solitary new <code>Nor3Gate</code> object.
     *
     * @param model the model
     */
    public Nor3Gate(Model model) {
        super(model, 3, 1);
    }
     ...
     * <code>LogicComponent</code> object. All <code>Nor3Gate</code> objects 
     * return <code>Nor3Gate.TYPE_STRING</code>.
     *
    ...
    static final public String TYPE_STRING = "nor3";
